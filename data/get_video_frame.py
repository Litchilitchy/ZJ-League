...
if __name__ == "__main__":
  testPath = './test_video'
  trainPath ='./train_video'

  if not os.path.exists(testPath + '/test_img'):
    os.mkdir(testPath + '/test_img')
  if not os.path.exists(trainPath + '/train_img'):
    os.mkdir(trainPath + '/train_img')

  testImgPath = './test_video/test_img/'
  trainImgPath = './train_video/train_img/'
